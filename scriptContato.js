function cadastrar() {
    document.getElementById("form").action = "../Classes/Contato/ContatoCriar.php";
}

function logar() {
    document.getElementById("form").action = "../Classes/Contato/conferirLogin.php";
}

function listar() {
    document.getElementById("form").action = "../Classes/Contato/ContatoLer.php";
}
